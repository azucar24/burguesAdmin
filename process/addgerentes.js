...
//mostrar datos
var tablaG = document.getElementById('tablaG');
        ...
        tablaG.innerHTML +=
            `<tr>
              ...
              <td>${doc.data().sucursal}</td>
                ...
                <button class="btn btn-warning" data-toggle="modal" data-target="#registrarEmpleado" onclick="editar('${doc.id}','${doc.data().nombre}','${doc.data().telefono}','${doc.data().sexo}','${doc.data().direccion}','${doc.data().dui}','${doc.data().sucursal}','${doc.data().correo}','${doc.data().password}')">Editar</button></td>
                </tr>
        `
    });
});
...
//actualizar datos
function editar(id, nombre, telefono, sexo, direccion, dui, sucursal, correo, password) {
